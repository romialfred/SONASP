/*
  # Fonctions RPC pour les Résumés de Production avec Budget/Forecast
  
  ## Problème
  Les fonctions get_wtd_summary et get_mtd_summary n'existent pas,
  ce qui empêche l'affichage des valeurs Budget, Forecast et Actual
  dans la page Daily Production.
  
  ## Solution
  Créer les fonctions RPC qui:
  - Calculent le total réalisé (Actual) depuis daily_production
  - Récupèrent le Budget depuis monthly_budgets
  - Récupèrent le Forecast depuis quarterly_forecasts
  - Calculent les variances
*/
