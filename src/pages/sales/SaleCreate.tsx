...
import { ArrowLeft, TrendingUp, Package, AlertCircle, CheckCircle, Building2, User } from 'lucide-react';
                ...
                <tbody className="divide-y divide-gray-200">
                  <tr className="hover:bg-gray-50">
                    <td className="px-6 py-4">
                      ...
                      <p className="text-sm text-gray-500">Fine gold to be sold</p>
                    </td>
                  ...
                  <tr className="hover:bg-gray-50">
                    <td className="px-6 py-4">
                      <p className="font-semibold text-gray-900">Price per oz</p>
                      <p className="text-sm text-gray-500">{mechanismData ? mechanismData.displayName : 'Sale price'}</p>
                    </td>
                    <td className="px-6 py-4 text-right">
                      <p className="font-bold text-gray-900">{formatCurrency(parseFloat(formData.londonAMRate))}</p>
                    </td>
                  </tr>
                  <tr className="bg-green-50 hover:bg-green-100">
                    <td className="px-6 py-4">
                      <p className="font-bold text-green-900">Gross Proceeds</p>
                      <p className="text-sm text-green-700">Quantity × Price</p>
                    </td>
                    <td className="px-6 py-4 text-right">
                      <p className="text-xl font-bold text-green-700">{formatCurrency(calculations.grossProceeds)}</p>
                    </td>
                  </tr>
                  {calculations.freight > 0 && (
                    <tr className="hover:bg-gray-50">
                      <td className="px-6 py-4">
                        <p className="font-semibold text-gray-900">Freight Cost</p>
                        <p className="text-sm text-gray-500">Transportation expenses</p>
                      </td>
                      <td className="px-6 py-4 text-right">
                        <p className="font-bold text-red-600">-{formatCurrency(calculations.freight)}</p>
                      </td>
                    </tr>
                  )}
                  {calculations.otherCosts > 0 && (
                    <tr className="hover:bg-gray-50">
                      <td className="px-6 py-4">
                        <p className="font-semibold text-gray-900">Other Costs</p>
                        <p className="text-sm text-gray-500">Additional expenses</p>
                      </td>
                      <td className="px-6 py-4 text-right">
                        <p className="font-bold text-red-600">-{formatCurrency(calculations.otherCosts)}</p>
                      </td>
                    </tr>
                  )}
                  <tr className="bg-blue-50 hover:bg-blue-100">
                    <td className="px-6 py-4">
                      <p className="font-bold text-blue-900">Net Proceeds</p>
                      <p className="text-sm text-blue-700">Gross - Costs</p>
                    </td>
                    <td className="px-6 py-4 text-right">
                      <p className="text-xl font-bold text-blue-700">{formatCurrency(calculations.netProceeds)}</p>
                    </td>
                  </tr>
                  <tr className="hover:bg-gray-50">
                    <td className="px-6 py-4">
                      <p className="font-semibold text-gray-900">Net Smelted Royalties</p>
                      <p className="text-sm text-gray-500">3% of net proceeds</p>
                    </td>
                    <td className="px-6 py-4 text-right">
                      <p className="font-bold text-red-600">-{formatCurrency(calculations.royalties)}</p>
                    </td>
                  </tr>
                  <tr className="bg-gradient-to-r from-indigo-100 to-purple-100 border-t-4 border-indigo-500">
                    <td className="px-6 py-5">
                      <p className="text-xl font-bold text-indigo-900">Final Proceeds</p>
                      <p className="text-sm text-indigo-700">Net - Royalties</p>
                    </td>
