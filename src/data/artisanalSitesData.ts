...
export const DEMO_ARTISANAL_SITES: ArtisanalSite[] = [
  {
    id: 'site-kalsaka', code: 'SA-2026-001', name: 'Site artisanal de Kalsaka', status: 'active',
    ...
    latitude: 13.178, longitude: -1.992,
  ...
  {
    id: 'site-poura', code: 'SA-2026-002', name: 'Site artisanal de Poura', status: 'active',
    ...
    averageHoleDepthMeters: 31, authorizedChemicals: ['Borax'], latitude: 11.586, longitude: -2.753,
  ...
  {
    id: 'site-gaoua', code: 'SA-2026-003', name: 'Site artisanal de Gaoua', status: 'active',
    ...
    averageHoleDepthMeters: 18, authorizedChemicals: ['Borax', 'Charbon actif'], latitude: 10.325, longitude: -3.174,
  ...
  {
    id: 'site-kongoussi', code: 'SA-2026-004', name: 'Site artisanal de Kongoussi', status: 'active',
    ...
    averageHoleDepthMeters: 27, authorizedChemicals: ['Borax'], latitude: 13.325, longitude: -1.535,
  ...
  {
    id: 'site-hounde', code: 'SA-2026-005', name: 'Site artisanal de Houndé', status: 'planned',
    ...
    averageHoleDepthMeters: 25, authorizedChemicals: ['Borax', 'Charbon actif'], latitude: 11.5, longitude: -3.516,
  ...
  {
    id: 'site-gorom', code: 'SA-2026-006', name: 'Site artisanal de Gorom-Gorom', status: 'suspended',
    ...
    averageHoleDepthMeters: 20, authorizedChemicals: ['Borax'], latitude: 14.443, longitude: -0.235,
