...
const base = 'docs/amelioration/environnement/reprise-r04';
...
DO $guard$ BEGIN
 IF NOT EXISTS(SELECT 1 FROM public.${table} WHERE id=${uuid} AND ${guard}) THEN
  RAISE EXCEPTION 'UUID absent ou dossier hors du préfixe QA20260907-R04 autorisé';
 END IF;
END; $guard$;
