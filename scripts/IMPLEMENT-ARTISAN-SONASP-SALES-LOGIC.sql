/*
  ...
  1. Modifications apportées
    ...
    - Ajout de contraintes pour garantir que l'acheteur est SONASP
  ...
  3. Sécurité
    ...
    - Contraintes pour empêcher les ventes à d'autres clients
*/
...
-- ============================================================================
-- ÉTAPE 6: Contrainte pour garantir que l'acheteur est SONASP
-- ============================================================================
...
BEGIN
  ...
  RAISE NOTICE '  4. Contrainte de base de données active';
