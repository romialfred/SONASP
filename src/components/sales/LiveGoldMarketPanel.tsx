...
export function LiveGoldMarketPanel({ onCollapseChange }: LiveGoldMarketPanelProps) {
  ...
  if (loading || !goldPrice) {
    return (
      <div className={`fixed top-20 right-0 transition-all duration-300 z-40 ${
        ...
        <div className="bg-white shadow-2xl rounded-l-2xl border-l border-gray-200 w-80 animate-pulse">
  ...
  return (
    ...
    >
      ...
      {/* Main Panel - Compact Version */}
      <div className="bg-white shadow-2xl rounded-l-2xl border-l border-gray-200 w-80" style={{ maxHeight: 'calc(100vh - 5rem)' }}>
        <div className="p-4 space-y-3">
          {/* Header - Compact */}
          ...
          <div className="flex items-center justify-center gap-1.5 text-xs bg-emerald-50 text-emerald-700 px-2.5 py-1.5 rounded-lg font-medium">
          ...
          <div className="text-center space-y-1.5">
            ...
            <div className="text-xs text-gray-500">per troy ounce</div>
          ...
          {/* Market Metrics Grid - Compact */}
          <div className="grid grid-cols-2 gap-2">
            {/* Market Open */}
            <div className="bg-gray-50 rounded-lg p-2 border border-gray-200">
              <div className="text-xs text-gray-500 mb-0.5">Market Open</div>
            ...
            <div className="bg-emerald-50 rounded-lg p-2 border border-emerald-200">
              <div className="text-xs text-emerald-600 mb-0.5">24h High</div>
            ...
            <div className="bg-red-50 rounded-lg p-2 border border-red-200">
              <div className="text-xs text-red-600 mb-0.5">24h Low</div>
            ...
            <div className="bg-white rounded-lg p-2 border border-gray-200">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-1.5">
                  ...
                  <span className="text-xs font-semibold text-gray-900">NYSE COMEX</span>
                </div>
                <span className={`text-xs px-1.5 py-0.5 rounded ${
                  marketStatus.newYork.isOpen
                    ? 'bg-emerald-100 text-emerald-700'
          ...
          {/* Trading Info - Compact */}
          <div className="bg-blue-50 rounded-lg p-2 border border-blue-200">
            <div className="text-xs font-semibold text-blue-900 mb-1">Official Source</div>
            <div className="text-xs text-blue-800 leading-relaxed">
              All gold prices sourced from London Bullion Market Association (LBMA) - the global authority for precious metals pricing and standards.
            </div>
          </div>

          {/* Last Update - Compact */}
          <div className="flex items-center justify-center gap-1.5 text-xs text-gray-500 pt-1 border-t border-gray-200">
