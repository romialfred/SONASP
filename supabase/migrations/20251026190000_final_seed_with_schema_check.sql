/*
  # Final Seed Data with Schema Verification

  1. Purpose
    - Ensure all required columns exist in tables before seeding
    - Insert clean seed data for testing and development
    - Create 3 customers, 20 batches, 16 sales, and 13 payments
...
BEGIN
  ...
  LOOP
    ...
    -- Create sale (using only columns that exist in base schema)
    INSERT INTO sales (
      id,
      sale_number,
      customer_id,
    ...
    -- Create payment for first 13 sales only (using only base columns + enhanced columns)
