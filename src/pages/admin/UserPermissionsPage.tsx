...
export function UserPermissionsPage() {
  ...
  const getModuleFields = (moduleName: string): string[] => {
    const fieldMap: Record<string, string[]> = {
      ...
      payments: ['invoice_number', 'amount', 'currency', 'fx_rate', 'expected_date', 'actual_date', 'bank_name', 'reference_number', 'proof_document'],
      payments_view: ['invoice_number', 'customer', 'amount', 'currency', 'due_date', 'status', 'payment_method'],
      payments_create: ['sale_id', 'customer_id', 'amount', 'currency', 'expected_date', 'bank_name', 'reference_number', 'notes'],
      payments_approve: ['amount', 'customer', 'bank_details', 'proof_document', 'approval_notes'],
      payments_documents: ['document_type', 'document_name', 'proof_url', 'notes', 'verification_status'],
