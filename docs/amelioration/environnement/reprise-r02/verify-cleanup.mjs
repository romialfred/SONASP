...
const plan=read(`${folder}/cleanup-plan.json`);
...
const evidence={verifiedAt:new Date().toISOString(),passed:true,removed,otherBaselineRowsUnchanged:true,
 storageMetadataUnchanged:true,schemaUnchanged:true,thirdPartyRowsPreserved:plan.thirdPartyChangesExcluded,
 preflightSha256:sha(`${folder}/cleanup-preflight.json`),postflightSha256:sha(postflightFile),candidateSha256:sha(`${folder}/cleanup-candidate.sql`),
