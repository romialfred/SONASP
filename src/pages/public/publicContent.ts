...
export const publicContent: Record<PublicLocale, PublicContent> = {
  fr: {
    ...
    hero: {
      eyebrow: 'Plateforme nationale de collecte et de vente de l’or',
    ...
    footer: {
      description: 'Infrastructure numérique nationale dédiée à la collecte, aux achats, aux ventes et au suivi des opérations aurifères.',
