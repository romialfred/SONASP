/*
  ...
  ## Changes
  - Add SET search_path to all calculation and utility functions
  - Add SET search_path to all trigger functions
  - Add SET search_path to all analytics and reporting functions
