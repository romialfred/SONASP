...
export function DomainRestriction({ children }: { children: React.ReactNode }) {
  useEffect(() => {
    ...
    const accessDeniedHTML = `
      ...
      <body style="margin: 0; padding: 0; font-family: 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; height: 100vh; overflow: hidden;">
        <div style="
          height: 100vh;
          display: flex;
          align-items: center;
        ...
        ">
          ...
          ">
            ...
            <div style="
              ...
              text-align: center;
            ">
              <svg style="width: 70px; height: 70px; margin: 0 auto 15px; display: block;" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2">
            ...
            <div style="padding: 30px 30px 25px 30px;">
              ...
              <div style="text-align: center; margin-bottom: 25px;">
                ...
                " onmouseover="
                  ...
                  this.style.boxShadow='0 15px 30px -5px rgba(20, 184, 166, 0.6)';
                " onmouseout="
                ...
                <div style="display: flex; flex-direction: column; gap: 12px;">
                  ...
                  <div style="display: flex; align-items: center; gap: 12px;">
                    <div style="
                      ...
                      flex-shrink: 0;
                    ">
                      <svg style="width: 18px; height: 18px;" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                      </svg>
                    </div>
                    <div>
                      <p style="margin: 0; color: #64748b; font-size: 0.8rem; font-weight: 500;">Email</p>
