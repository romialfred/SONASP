...
import { GoldPriceWidget } from '@/components/sales/GoldPriceWidget';
    ...
    <MainLayout>
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="space-y-6">
            <GoldPriceWidget showDetailed={true} />

            <Card>
              <div className="p-5 space-y-4">
                <div className="flex items-center gap-2">
                  <Users className="w-5 h-5 text-gray-700" />
                  <h3 className="font-semibold text-gray-900">Available Customers</h3>
                </div>
                ...
                {customers.length > 5 && (
                  <p className="text-xs text-gray-500 text-center">
                    +{customers.length - 5} more customers available
                  </p>
                )}
              </div>
            </Card>
